...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFD5D5DD);
  ...
  late Color accent2 = const Color(0xFFF7E3BD);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xDF2A2A2F);
  late Color secondary = const Color(0xFF1B1D20);
  late Color tertiary = const Color(0xFFCE4CC8);
  ...
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0xFF15163C);
  late Color accent3 = const Color(0x4DEE8B60);
